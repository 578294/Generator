...
def index():
    ...
    gen.username = request.form["username"]
    gen.hostname = request.form["hostname"]
    gen.port = request.form["port"]
    gen.password = request.form["password"]

    action = request.form.get("action", "SSH")
